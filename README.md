...
[**DEPLOY.md**](https://github.com/marconucara/web-vault/blob/v0.5.4/DEPLOY.md#3-gate-the-site-with-cloudflare-access) —
...
- **Agent-driven setup into an existing vault** — if you already have a Markdown
  ...
  [WebVault's SETUP.md](https://github.com/marconucara/web-vault/blob/v0.5.4/SETUP.md).
